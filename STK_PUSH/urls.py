...
urlpatterns = [
        ...
        path('add-meeting/', views.add_meeting, name='add-meeting'),
        path('meeting/<int:meeting_id>/', views.meeting_detail, name='meeting-detail'),
        path('articles', views.articles, name='articles'),
        path('delete-meeting/<int:meeting_id>/', views.delete_meeting, name='delete-meeting'),
        path('register/', views.register, name="register"),
        path('login/', views.user_login, name="login"),
        path('admin', views.admin, name="admin_sign"),
